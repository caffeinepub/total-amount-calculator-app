...
import type { PredefinedItemCatalogProps } from "./PredefinedItemCatalog.types";
...
export function PredefinedItemCatalog({
  ...
  const handleNewItemImageSelect = async (
  ...
  const handleAddNewItem = () => {
    ...
    if (!newItemName.trim() || Number.isNaN(price) || price < 0) {
                ...
                <div key={category} className="space-y-2">
                  ...
                  <div className="space-y-2">
                    {categoryItems.map((item) => {
                      const addedCount = getAddedCountForCatalogItem(
                        item.name,
                        lineItems,
                      );
                      return (
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <div className="flex items-center gap-1">
                                <input
                                  ...
                                  accept="image/*"
                                  onChange={(e) =>
                                    handleItemImageChange(item.id, e)
                                  }
                                  className="hidden"
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    document
                                      .getElementById(`image-input-${item.id}`)
                                      ?.click()
                                  }
                                  className="h-8 w-8"
                                  title={
